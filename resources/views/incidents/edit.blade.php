                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="severity" class="form-control">
                                <option value="Menor" @if($incident->severity=='Menor') selected @endif)>Menor</option>
                                <option value="Normal" @if($incident->severity=='Normal') selected @endif>Normal</option>
                                <option value="Mayor" @if($incident->severity=='Mayor') selected @endif>Mayor</option>
                            </select>
                        </div>
                        <div class="form-group">
