            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td id="incident_severity">{{$incident->severity}}</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="table table-bordered">
                    ...
                    @if(auth()->user()->id == $incident->client_id)
                        @if($incident->active)
                            <a href="/incidencia/{{$incident->id}}/editar" class="btn btn-warning btn-sm" id="incident_btn_edit">Editar incidencia</a>
